...
Write-Host "Upgrade including: Add Windows Photo Viewer; Add monitoring disk in manager; Add WLAN services; Add Briefcase." -ForegroundColor Yellow -BackgroundColor Black
