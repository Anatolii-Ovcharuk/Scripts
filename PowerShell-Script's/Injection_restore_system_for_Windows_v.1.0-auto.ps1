...
# Notice for future: This script is automated. The system will restart.
...
Write-Host "Notice for future: This script is automated. The system will restart." -ForegroundColor Red -BackgroundColor Black
