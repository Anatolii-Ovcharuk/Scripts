...
REM Autorestart: 7DTD Server for Windows. Made by Anatolii Ovcharuk. Version 0.5 for Windows - Update 01.09.2024 / MIT License
...
echo Autorestart: 7DTD Server for Windows. Made by Anatolii Ovcharuk. Version 0.5 for Windows - Update 01.09.2024 / MIT License
