...
REM Autorestart: 7DTD Server for Windows. Made by Anatolii Ovcharuk. Version 1.1 for Windows - Update 30.09.2024 / MIT License
...
echo Autorestart: 7DTD Server for Windows. Made by Anatolii Ovcharuk. Version 1.1 for Windows - Update 30.09.2024 / MIT License
