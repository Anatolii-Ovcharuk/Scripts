...
REM This is .bat file script for Windows, using PowerShell to run JS via Node.js
...
echo This is .bat file script for Windows, using PowerShell to run JS via Node.js
